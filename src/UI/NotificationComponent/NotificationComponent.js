...
class NotificationComponent extends Component {
  ...
  pushNewNotification = newNotification => {
    this.setState({ notifications: [newNotification, ...this.state.notifications] });
  };
